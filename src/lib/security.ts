...
export const SECURITY_HEADERS: SecurityHeadersConfig = {
  ...
  csp: [
    ...
    "img-src 'self' data: blob: https://images.unsplash.com https://assets.mixkit.co https://raw.githubusercontent.com https://cdn.jsdelivr.net https://*.githubusercontent.com https://api.qrserver.com https://*.r2.cloudflarestorage.com https://*.cloudflarestorage.com https://*.lumiardi.com",
    "media-src 'self' data: blob: https://assets.mixkit.co https://commondatastorage.googleapis.com https://*.r2.cloudflarestorage.com https://*.cloudflarestorage.com https://*.lumiardi.com",
    "connect-src 'self' blob: data: https://fonts.googleapis.com https://fonts.gstatic.com https://images.unsplash.com https://raw.githubusercontent.com https://*.githubusercontent.com https://cdn.jsdelivr.net https://dl.polyhaven.org https://market-assets.fra1.cdn.digitaloceanspaces.com https://*.r2.cloudflarestorage.com https://*.cloudflarestorage.com https://*.lumiardi.com",
